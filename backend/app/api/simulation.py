...
def _get_latest_report_for_simulation(simulation_id: str) -> dict | None:
    """Return latest report meta fields for a simulation, or None."""
    import json
            ...
            try:
                ...
                if meta.get("simulation_id") == simulation_id:
                    ...
                    matching_reports.append({
                        ...
                        "live_world": bool(capabilities.get("live_world")),
                    })
            except Exception:
                continue
...
def _get_report_id_for_simulation(simulation_id: str) -> str:
    """Return latest report_id for a simulation, or None."""
    meta = _get_latest_report_for_simulation(simulation_id)
...
def get_simulation_history():
    ...
    try:
        ...
        for sim in simulations:
            ...
            report_meta = _get_latest_report_for_simulation(sim.simulation_id)
            if report_meta:
                sim_dict["report_id"] = report_meta.get("report_id")
                sim_dict["report_status"] = report_meta.get("status") or ""
                sim_dict["live_world"] = bool(report_meta.get("live_world"))
            else:
                sim_dict["report_id"] = None
                sim_dict["report_status"] = ""
                sim_dict["live_world"] = False
